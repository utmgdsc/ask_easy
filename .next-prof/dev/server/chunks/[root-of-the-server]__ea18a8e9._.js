...
/* eslint-disable */ var bu = Object.create;
...
async function yl(e, r) {
    ...
    let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/src/generated/prisma/runtime/library.js").match(ef()) === null, c = {
        searchedLocations: i,
...
exports.Prisma.SlideSetScalarFieldEnum = {
    id: 'id',
    sessionId: 'sessionId',
    filename: 'filename',
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "/Users/notjackl3/Programming/ask_easy/src/generated/prisma",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/Users/notjackl3/Programming/ask_easy/prisma/schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "8402b485164df106cb23910e17df29e07a6a9b266271461b7dfbedb5c6a5d6e4",
    "copyEngine": true
};
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$ioredis__$5b$external$5d$__$28$ioredis$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$ioredis$40$5$2e$9$2e$2$2f$node_modules$2f$ioredis$29$__ = __turbopack_context__.i("[externals]/ioredis [external] (ioredis, cjs, [project]/node_modules/.pnpm/ioredis@5.9.2/node_modules/ioredis)");
;
...
const redisCache = new __TURBOPACK__imported__module__$5b$externals$5d2f$ioredis__$5b$external$5d$__$28$ioredis$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$ioredis$40$5$2e$9$2e$2$2f$node_modules$2f$ioredis$29$__["default"](REDIS_URL, {
    ...sharedOptions,
    db: 0
});
const redisPubSub = new __TURBOPACK__imported__module__$5b$externals$5d2f$ioredis__$5b$external$5d$__$28$ioredis$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$ioredis$40$5$2e$9$2e$2$2f$node_modules$2f$ioredis$29$__["default"](REDIS_URL, {
    ...sharedOptions,
    db: 1
});
const redisRateLimit = new __TURBOPACK__imported__module__$5b$externals$5d2f$ioredis__$5b$external$5d$__$28$ioredis$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$ioredis$40$5$2e$9$2e$2$2f$node_modules$2f$ioredis$29$__["default"](REDIS_URL, {
    ...sharedOptions,
    db: 2
});
...
"[project]/src/lib/redisKeys.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s([
    ...
    ()=>sessionCreateRateLimit,
    "sessionJoinLookupRateLimit",
    ()=>sessionJoinLookupRateLimit,
    "sessionJoinRegisterRateLimit",
    ()=>sessionJoinRegisterRateLimit,
    "slideState",
    ()=>slideState,
    "slideUploadRateLimit",
    ()=>slideUploadRateLimit,
    "upvoteRateLimit",
    ()=>upvoteRateLimit
]);
...
function questionRateLimit(userId) {
    return `question:${userId}`;
}
function answerRateLimit(userId) {
    return `answer:${userId}`;
}
function slideUploadRateLimit(userId) {
    return `slide-upload:${userId}`;
}
function upvoteRateLimit(userId) {
    return `upvote:${userId}`;
}
function resolveRateLimit(userId) {
    return `resolve:${userId}`;
}
function sessionCreateRateLimit(userId) {
    return `session-create:${userId}`;
}
function codeRegenRateLimit(userId) {
    return `code-regen:${userId}`;
}
function sessionJoinLookupRateLimit(userId) {
    return `session-join-lookup:${userId}`;
}
function sessionJoinRegisterRateLimit(userId) {
    return `session-join-register:${userId}`;
}
function slideState(sessionId) {
    return `slide-state:{${sessionId}}`;
}
function answerMode(sessionId) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/redisKeys.ts [app-route] (ecmascript)");
;
;
async function incrementRateLimit(key, windowSeconds) {
    try {
        const redisKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimit"])(key);
        const count = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisRateLimit"].incr(redisKey);
        // Set expiration on first increment (when count is 1)
        if (count === 1) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisRateLimit"].expire(redisKey, windowSeconds);
        }
        return count;
    } catch (error) {
        console.error("[RateLimit] Redis error — failing closed to protect against unbounded requests:", error);
...
"[project]/src/lib/sessionValidation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SESSION_CREATE_RATE_LIMIT_COUNT = 10;
const SESSION_CREATE_RATE_LIMIT_WINDOW_SECONDS = 3600; // 1 hour
...
async function checkSessionCreateRateLimit(userId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sessionCreateRateLimit"])(userId), SESSION_CREATE_RATE_LIMIT_COUNT, SESSION_CREATE_RATE_LIMIT_WINDOW_SECONDS);
}
}),
...
"[project]/src/lib/sessionCode.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateSessionCode(length = DEFAULT_CODE_LENGTH) {
    return Array.from({
        length
    }, ()=>CODE_CHARS[(0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomInt"])(CODE_CHARS.length)]).join("");
}
async function isCodeAvailable(code) {
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findUnique({
        where: {
...
async function generateUniqueSessionCode(maxRetries = DEFAULT_MAX_RETRIES) {
...
async function regenerateSessionCode(sessionId, userId) {
...
const UPLOADS_DIR = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "uploads");
/**
 ...
 */ function resolveStoragePath(key) {
    const resolved = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].resolve(UPLOADS_DIR, key);
    ...
    if (!resolved.startsWith(UPLOADS_DIR + __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].sep) && resolved !== UPLOADS_DIR) {
 ...
 */ async function ensureDirectory(dirPath) {
    try {
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].access(dirPath);
    } catch  {
...
async function uploadFile(key, buffer, // eslint-disable-next-line @typescript-eslint/no-unused-vars -- kept for interface compatibility
_contentType) {
...
async function deleteFile(key) {
    const filePath = resolveStoragePath(key);
    try {
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].unlink(filePath);
    } catch (error) {
...
async function readFile(key) {
    const filePath = resolveStoragePath(key);
    return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(filePath);
}
function generateSlideStorageKey(sessionId, slideSetId) {
...
function getSessionOptions() {
    ...
    if (!secret) {
        throw new Error("SESSION_SECRET environment variable is not set. Generate one with: openssl rand -hex 32");
    }
    if (secret === KNOWN_WEAK_SECRET || secret.length < 32) {
        throw new Error("SESSION_SECRET is insecure: it is either the example placeholder or shorter than 32 characters. " + "Generate a strong secret with: openssl rand -hex 32");
    }
    return {
        password: secret,
        cookieName: process.env.SESSION_COOKIE_NAME ?? "ask_easy_session",
        cookieOptions: {
...
"[project]/src/socket/middleware/auth.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function authMiddleware(socket, next) {
    ...
    const opts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionOptions"])();
    const sealedSession = cookies[opts.cookieName];
    if (!sealedSession) {
        return next(new Error("Authentication required. No session cookie found."));
    }
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$iron$2d$session$40$8$2e$0$2e$4$2f$node_modules$2f$iron$2d$session$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unsealData"])(sealedSession, {
...
"[project]/src/lib/questionValidation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const UPVOTE_RATE_LIMIT_COUNT = 30;
const UPVOTE_RATE_LIMIT_WINDOW_SECONDS = 60;
const RESOLVE_RATE_LIMIT_COUNT = 20;
const RESOLVE_RATE_LIMIT_WINDOW_SECONDS = 60;
...
async function checkQuestionRateLimit(userId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["questionRateLimit"])(userId), RATE_LIMIT_COUNT, RATE_LIMIT_WINDOW_SECONDS);
}
async function checkUpvoteRateLimit(userId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upvoteRateLimit"])(userId), UPVOTE_RATE_LIMIT_COUNT, UPVOTE_RATE_LIMIT_WINDOW_SECONDS);
}
async function checkResolveRateLimit(userId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveRateLimit"])(userId), RESOLVE_RATE_LIMIT_COUNT, RESOLVE_RATE_LIMIT_WINDOW_SECONDS);
}
async function validateSessionForQuestions(sessionId) {
    const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findUnique({
        where: {
            id: sessionId
        },
...
"[project]/src/socket/handlers/questionHandlers.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/questionValidation.ts [app-route] (ecmascript)");
;
;
function broadcastQuestion(io, sessionId, question) {
    const targetRoom = question.visibility === "INSTRUCTOR_ONLY" ? `session:${sessionId}:instructors` : `session:${sessionId}`;
    io.to(targetRoom).emit("question:created", question);
}
function handleQuestionCreate(socket, io) {
    socket.on("question:create", async (payload)=>{
        ...
        try {
            ...
            const contentValidation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateQuestionContent"])(payload.content);
            ...
            const visibilityValidation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateVisibility"])(payload.visibility);
            if (!visibilityValidation.valid) {
                console.log("[QuestionHandler] Rejected: visibility validation -", visibilityValidation.error);
                socket.emit("question:error", {
                    message: visibilityValidation.error
                });
                return;
            }
            // 5. Rate limit (first async check — only reached if all sync checks pass)
            const isRateLimited = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkQuestionRateLimit"])(userId);
            if (isRateLimited) {
            ...
            const sessionValidation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateSessionForQuestions"])(payload.sessionId);
            ...
            const sessionForEnrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findUnique({
                where: {
            ...
            let authorEnrollmentRole = "STUDENT";
            if (sessionForEnrollment) {
                const enrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                    where: {
                        userId_courseId: {
                            userId,
                            courseId: sessionForEnrollment.courseId
                        }
                    },
                    select: {
                        role: true
            ...
            if (question.isAnonymous) {
                io.to(`session:${question.sessionId}:instructors`).emit("question:author:revealed", {
                    ...
                    authorName: question.author?.name ?? null,
                    authorUtorid: question.author?.utorid ?? null,
                    authorRole: authorEnrollmentRole
                });
            }
        } catch (error) {
...
function handleQuestionUpvote(socket, io) {
    socket.on("question:upvote", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            // 3. Rate limit
            const isRateLimited = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkUpvoteRateLimit"])(userId);
            if (isRateLimited) {
                socket.emit("question:error", {
            ...
            const questionForEnrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.findUnique({
                where: {
                    id: questionId
                },
                select: {
            ...
            if (questionForEnrollment) {
                const enrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                    where: {
                        userId_courseId: {
                            userId,
                            courseId: questionForEnrollment.session.courseId
                        }
                    },
                    select: {
                        role: true
            ...
            const existingUpvote = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].questionUpvote.findUnique({
                where: {
                    questionId_userId: {
                        questionId,
                        userId
            ...
            if (existingUpvote) {
                // Remove upvote
                [, updatedQuestion] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].questionUpvote.delete({
                        where: {
                            id: existingUpvote.id
                        }
                    }),
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.update({
                        where: {
                            id: questionId
                        },
                        data: {
                ...
                // Add upvote
                [, updatedQuestion] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].questionUpvote.create({
                        data: {
                            questionId,
                            userId
                        }
            ...
            const targetRoom = updatedQuestion.visibility === "INSTRUCTOR_ONLY" ? `session:${updatedQuestion.sessionId}:instructors` : `session:${updatedQuestion.sessionId}`;
 ...
 */ function checkResolvePermission(userId, questionAuthorId, enrollmentRole) {
    if (enrollmentRole === "TA" || enrollmentRole === "PROFESSOR") {
        return true;
    }
    return questionAuthorId === userId;
}
function handleQuestionResolve(socket, io) {
    socket.on("question:resolve", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            // 3. Rate limit
            const isRateLimited = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkResolveRateLimit"])(userId);
            if (isRateLimited) {
                socket.emit("question:error", {
            ...
            const question = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.findUnique({
                where: {
                    id: questionId
                },
                select: {
            ...
            const enrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                where: {
                    userId_courseId: {
                        userId,
                        courseId: question.session.courseId
                    }
                },
                select: {
                    role: true
            ...
            // 6. Update status
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.update({
                where: {
                    id: questionId
                },
                data: {
            ...
            const targetRoom = question.visibility === "INSTRUCTOR_ONLY" ? `session:${question.sessionId}:instructors` : `session:${question.sessionId}`;
...
function handleQuestionDelete(socket, io) {
    socket.on("question:delete", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            // 2. Payload shape guard
            if (!payload || typeof payload !== "object" || typeof payload.questionId !== "string" || typeof payload.sessionId !== "string") {
                socket.emit("question:error", {
                    message: "Invalid request."
                });
                return;
            ...
            const requesterEnrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                where: {
                    userId_courseId: {
                        userId,
                        courseId
            ...
            if (requesterRole === "TA") {
                ...
                if (!isOwn) {
                    const authorEnrollment = question.authorId ? await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                        where: {
                            userId_courseId: {
            ...
            // 7. Broadcast to the appropriate room
            const targetRoom = question.visibility === "INSTRUCTOR_ONLY" ? `session:${sessionId}:instructors` : `session:${sessionId}`;
            io.to(targetRoom).emit("question:deleted", {
                questionId
            });
        } catch (error) {
...
"[project]/src/lib/answerValidation.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function checkAnswerRateLimit(userId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["answerRateLimit"])(userId), RATE_LIMIT_COUNT, RATE_LIMIT_WINDOW_SECONDS);
}
async function validateQuestionForAnswers(questionId) {
    const question = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.findUnique({
        where: {
            id: questionId
        },
...
"[project]/src/socket/handlers/answerHandlers.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/redis.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/redisKeys.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$answerValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/answerValidation.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$questionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/questionValidation.ts [app-route] (ecmascript)");
;
;
;
;
;
function broadcastAnswer(io, sessionId, answer) {
    io.to(`session:${sessionId}`).emit("answer:created", answer);
}
function handleAnswerCreate(socket, io) {
    socket.on("answer:create", async (payload)=>{
        try {
            // 1. Auth guard — userId is attached by socket auth middleware
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            const questionValidation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$answerValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateQuestionForAnswers"])(payload.questionId);
            ...
            const sessionRecord = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findUnique({
                where: {
                    id: sessionId
                },
                select: {
            ...
            const answerEnrollment = sessionRecord ? await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                where: {
                    userId_courseId: {
                        userId,
            ...
            const mode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisCache"].get((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["answerMode"])(sessionId));
            ...
            const contentValidation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$answerValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateAnswerContent"])(payload.content);
            if (!contentValidation.valid) {
                socket.emit("answer:error", {
                    message: contentValidation.error
                });
            ...
            const isRateLimited = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$answerValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkAnswerRateLimit"])(userId);
            if (isRateLimited) {
                socket.emit("answer:error", {
                    message: "You have reached the answer limit. Please wait before submitting another answer."
                });
                return;
            }
            // 7. Persist to database
            const answer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].answer.create({
                data: {
            ...
            const broadcastPayload = {
                ...
                authorRole: answerEnrollment.role,
            ...
            if (answer.isAnonymous) {
                io.to(`session:${questionValidation.question.sessionId}:instructors`).emit("answer:author:revealed", {
                    id: answer.id,
                    questionId: answer.questionId,
                    authorId: answer.author.id,
                    authorName: answer.author.name,
...
function handleAnswerUpvote(socket, io) {
    socket.on("answer:upvote", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            const answer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].answer.findUnique({
                where: {
                    id: answerId
                },
                select: {
            ...
            // 4a. Enrollment check
            const upvoteEnrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                where: {
                    userId_courseId: {
                        userId,
                        courseId: answer.question.session.courseId
                    }
                },
                select: {
                    role: true
            ...
            // 5. Toggle upvote in a transaction
            const existingUpvote = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].answerUpvote.findUnique({
                where: {
                    answerId_userId: {
                        answerId,
                        userId
            ...
            let updatedAnswer;
            if (existingUpvote) {
                [, updatedAnswer] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].answerUpvote.delete({
                        where: {
                            id: existingUpvote.id
                        }
                    }),
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].answer.update({
                        where: {
                            id: answerId
                        },
                        data: {
                ...
                [, updatedAnswer] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].answerUpvote.create({
                        data: {
                            answerId,
                            userId
                        }
...
function handleAnswerDelete(socket, io) {
    socket.on("answer:delete", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            // 2. Payload shape guard
            if (!payload || typeof payload !== "object" || typeof payload.answerId !== "string" || typeof payload.sessionId !== "string") {
                socket.emit("answer:error", {
                    message: "Invalid request."
                });
                return;
            ...
            if (requesterRole === "TA") {
                ...
                if (!isOwn) {
                    const authorEnrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                        where: {
                            userId_courseId: {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].answer.delete({
                where: {
                    id: answerId
                }
            });
...
"[project]/src/socket/handlers/slideHandlers.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/redis.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/redisKeys.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/sessionService.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
// ---------------------------------------------------------------------------
...
function handleSlideChange(socket, io) {
    socket.on("slide:change", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireSocketInstructor"])(userId, sessionId);
            // 4. Persist current page to Redis with a 24-hour TTL
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisCache"].set((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slideState"])(sessionId), pageIndex, "EX", SLIDE_STATE_TTL_SECONDS);
            // 5. Broadcast to all participants in the session room
            io.to(`session:${sessionId}`).emit("slide:changed", {
                pageIndex
            });
        } catch (error) {
            if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SessionNotFoundError"]) {
                socket.emit("slide:error", {
                    message: "Session not found."
                });
            } else if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotEnrolledError"]) {
            ...
            } else if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotInstructorError"]) {
                console.warn("[Security]", {
                    userId: socket.data?.userId,
                    sessionId: payload?.sessionId,
                    action: "slide:change",
...
function handleSlidesUploaded(socket, io) {
    socket.on("slides:uploaded", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            if (!slideSetId || typeof slideSetId !== "string") {
                socket.emit("slide:error", {
                    message: "Slide set ID is required."
                });
                return;
            }
            ...
            io.to(`session:${sessionId}`).emit("slides:available", {
                slideSetId
            });
        } catch (error) {
            if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SessionNotFoundError"]) {
                ...
                socket.emit("slide:error", {
                    message: "Only professors can broadcast slide updates."
                });
            } else {
...
function handleSlideSync(socket) {
    socket.on("slide:sync", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireSocketEnrollment"])(userId, sessionId);
            // 4. Read current page index from Redis
            const stored = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisCache"].get((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slideState"])(sessionId));
            ...
            if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotEnrolledError"] || error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SessionNotFoundError"]) {
                socket.emit("slide:error", {
                    message: "You are not enrolled in this session."
                });
            } else {
...
"[project]/src/socket/handlers/sessionHandlers.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function handleAnswerModeChange(socket, io) {
    socket.on("answer-mode:change", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireSocketInstructor"])(userId, sessionId);
            // 4. Persist to Redis
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisCache"].set((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["answerMode"])(sessionId), mode, "EX", ANSWER_MODE_TTL_SECONDS);
            // 5. Broadcast to all participants
            io.to(`session:${sessionId}`).emit("answer-mode:changed", {
                mode
            });
        } catch (error) {
            if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotEnrolledError"] || error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotInstructorError"]) {
                console.warn("[Security]", {
                    userId: socket.data?.userId,
                    sessionId: payload?.sessionId,
            ...
            } else if (!(error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SessionNotFoundError"])) {
                console.error("[SessionHandler] Failed to process answer-mode:change:", error);
            }
        }
    });
}
function handleAnswerModeSync(socket) {
    socket.on("answer-mode:sync", async (payload)=>{
        try {
            // 1. Auth guard
            const userId = socket.data?.userId;
            if (!userId) return;
            ...
            const stored = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisCache"].get((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$redisKeys$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["answerMode"])(sessionId));
            const mode = stored === "all" || stored === "instructors_only" ? stored : "instructors_only";
            // 5. Reply to requesting socket only
            socket.emit("answer-mode:changed", {
                mode
            });
        } catch (error) {
            if (!(error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NotEnrolledError"]) && !(error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SessionNotFoundError"])) {
...
"[project]/src/socket/index.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$socket$2e$io__$5b$external$5d$__$28$socket$2e$io$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$socket$2e$io$40$4$2e$8$2e$3$2f$node_modules$2f$socket$2e$io$29$__ = __turbopack_context__.i("[externals]/socket.io [external] (socket.io, esm_import, [project]/node_modules/.pnpm/socket.io@4.8.3/node_modules/socket.io)");
var __TURBOPACK__imported__module__$5b$externals$5d2f40$socket$2e$io$2f$redis$2d$adapter__$5b$external$5d$__$2840$socket$2e$io$2f$redis$2d$adapter$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$socket$2e$io$2b$redis$2d$adapter$40$8$2e$3$2e$0_socket$2e$io$2d$adapter$40$2$2e$5$2e$6$2f$node_modules$2f40$socket$2e$io$2f$redis$2d$adapter$29$__ = __turbopack_context__.i("[externals]/@socket.io/redis-adapter [external] (@socket.io/redis-adapter, cjs, [project]/node_modules/.pnpm/@socket.io+redis-adapter@8.3.0_socket.io-adapter@2.5.6/node_modules/@socket.io/redis-adapter)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$ioredis__$5b$external$5d$__$28$ioredis$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$ioredis$40$5$2e$9$2e$2$2f$node_modules$2f$ioredis$29$__ = __turbopack_context__.i("[externals]/ioredis [external] (ioredis, cjs, [project]/node_modules/.pnpm/ioredis@5.9.2/node_modules/ioredis)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/socket/middleware/auth.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$questionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/socket/handlers/questionHandlers.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$answerHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/socket/handlers/answerHandlers.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$slideHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/socket/handlers/slideHandlers.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$sessionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/socket/handlers/sessionHandlers.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$externals$5d2f$socket$2e$io__$5b$external$5d$__$28$socket$2e$io$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$socket$2e$io$40$4$2e$8$2e$3$2f$node_modules$2f$socket$2e$io$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$slideHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$sessionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$externals$5d2f$socket$2e$io__$5b$external$5d$__$28$socket$2e$io$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$socket$2e$io$40$4$2e$8$2e$3$2f$node_modules$2f$socket$2e$io$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$slideHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$sessionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function initSocketIO(httpServer) {
    const REDIS_URL = process.env.REDIS_URL || "redis://localhost:6379";
    io = new __TURBOPACK__imported__module__$5b$externals$5d2f$socket$2e$io__$5b$external$5d$__$28$socket$2e$io$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$socket$2e$io$40$4$2e$8$2e$3$2f$node_modules$2f$socket$2e$io$29$__["Server"](httpServer, {
        cors: {
    ...
    if (useRedisAdapter) {
        try {
            pubClient = new __TURBOPACK__imported__module__$5b$externals$5d2f$ioredis__$5b$external$5d$__$28$ioredis$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$ioredis$40$5$2e$9$2e$2$2f$node_modules$2f$ioredis$29$__["default"](REDIS_URL);
            subClient = new __TURBOPACK__imported__module__$5b$externals$5d2f$ioredis__$5b$external$5d$__$28$ioredis$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$ioredis$40$5$2e$9$2e$2$2f$node_modules$2f$ioredis$29$__["default"](REDIS_URL);
            await Promise.all([
            ...
            io.adapter((0, __TURBOPACK__imported__module__$5b$externals$5d2f40$socket$2e$io$2f$redis$2d$adapter__$5b$external$5d$__$2840$socket$2e$io$2f$redis$2d$adapter$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$socket$2e$io$2b$redis$2d$adapter$40$8$2e$3$2e$0_socket$2e$io$2d$adapter$40$2$2e$5$2e$6$2f$node_modules$2f40$socket$2e$io$2f$redis$2d$adapter$29$__["createAdapter"])(pubClient, subClient));
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                console.warn("[Socket.IO] Redis unavailable, running without adapter (single-instance only):", err instanceof Error ? err.message : err);
    ...
    // -----------------------------------------------------------------------
    io.use(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authMiddleware"]);
    // -----------------------------------------------------------------------
    // Connection handler
    // -----------------------------------------------------------------------
    async function broadcastViewerCount(sessionId) {
        ...
        io.to(`session:${sessionId}`).emit("viewer:count", {
            count
        });
    }
    io.on("connection", (socket)=>{
        ...
        socket.on("session:join", async (payload)=>{
            if (payload?.sessionId && typeof payload.sessionId === "string") {
                ...
                let enrollment = null;
                if (userId) {
                    enrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                        where: {
                            userId_courseId: {
                                userId,
                                courseId: sessionRecord.courseId
        ...
        socket.on("viewer:sync", async (payload)=>{
            if (payload?.sessionId && typeof payload.sessionId === "string") {
                ...
                const syncSession = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findUnique({
                    where: {
                        id: payload.sessionId
                    },
                    select: {
                ...
                const syncEnrollment = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findUnique({
                    where: {
                        userId_courseId: {
                            userId,
                            courseId: syncSession.courseId
                        }
                    },
                    select: {
                        role: true
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$questionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleQuestionCreate"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$questionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleQuestionUpvote"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$questionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleQuestionResolve"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$questionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleQuestionDelete"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$answerHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleAnswerCreate"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$answerHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleAnswerUpvote"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$answerHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleAnswerDelete"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$slideHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleSlideChange"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$slideHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleSlideSync"])(socket);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$slideHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleSlidesUploaded"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$sessionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleAnswerModeChange"])(socket, io);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$handlers$2f$sessionHandlers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleAnswerModeSync"])(socket);
...
"[project]/src/lib/sessionService.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    ()=>requireSocketInstructor,
    "validateProfessorRole",
    ()=>validateProfessorRole
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionCode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/sessionCode.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/socket/index.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
class NotEnrolledError extends Error {
    ...
    constructor(userId, sessionId){
        super("You are not enrolled in this session."), this.userId = userId, this.sessionId = sessionId;
        this.name = "NotEnrolledError";
    }
}
class NotInstructorError extends Error {
    userId;
    sessionId;
    actualRole;
    constructor(userId, sessionId, actualRole){
        super("Only professors can perform this action."), this.userId = userId, this.sessionId = sessionId, this.actualRole = actualRole;
...
class SessionNotFoundError extends Error {
    ...
    constructor(sessionId){
        super("Session not found."), this.sessionId = sessionId;
        this.name = "SessionNotFoundError";
    }
}
async function requireSocketEnrollment(userId, sessionId) {
    const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findUnique({
        where: {
            id: sessionId
        },
...
async function requireSocketInstructor(userId, sessionId) {
...
async function getSessionMembership(sessionId, userId) {
    const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findUnique({
        where: {
            id: sessionId
        },
...
async function validateProfessorRole(userId, courseId) {
    // First check if course exists
    const course = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].course.findUnique({
        where: {
            id: courseId
        },
        select: {
...
async function createSession(data) {
    ...
    const joinCode = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionCode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateUniqueSessionCode"])();
...
async function performSessionEnd(sessionId) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.update({
        where: {
            id: sessionId
        },
    ...
    try {
        const io = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$socket$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIO"])();
        io.to(`session:${sessionId}`).emit("session:ended", {});
    } catch  {
    // Socket.IO not initialised in test environments — safe to ignore
    }
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.deleteMany({
            where: {
                sessionId
            }
        });
    ...
    try {
        const slideSets = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].slideSet.findMany({
            where: {
                sessionId
            },
            select: {
        ...
        await Promise.allSettled(slideSets.map((ss)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteFile"])(ss.storageKey).catch((err)=>console.error(`[SessionService] Failed to delete slide file ${ss.storageKey}:`, err))));
        if (slideSets.length > 0) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].slideSet.deleteMany({
                where: {
                    sessionId
                }
            });
...
async function checkAndAutoEnd(sessionId) {
    const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findUnique({
        where: {
            id: sessionId
        },
    ...
    console.info(`[SessionService] Auto-ending session ${sessionId} after ${Math.round(inactiveMs / 60_000)} minutes of inactivity.`);
...
async function getCurrentUser() {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$iron$2d$session$40$8$2e$0$2e$4$2f$node_modules$2f$iron$2d$session$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIronSession"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])(), (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionOptions"])());
    if (!session.userId) {
        return null;
    }
    return {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/sessionValidation.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/sessionService.ts [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const titleValidation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionValidation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateSessionTitle"])(title);
        if (!titleValidation.valid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sessionService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSession"])({
            courseId,
            title: title.trim(),
            userId
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ea18a8e9._.js.map