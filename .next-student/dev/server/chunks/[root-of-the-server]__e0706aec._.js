...
async function GET() {
    try {
        ...
        const enrollments = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].courseEnrollment.findMany({
            where: {
                userId: user.userId
            },
            include: {
...
async function POST(request) {
    try {
        ...
        const { code, section, students, tas } = body;
        ...
        const tasArray = Array.isArray(tas) ? tas.map((t)=>typeof t === "string" ? t.trim().toLowerCase() : "").filter(Boolean) : [];
        const semester = getCurrentSemester();
        const courseCode = code.trim();
        const courseName = typeof section === "string" && section.trim() ? `${courseCode} ${section.trim()}` : courseCode;
        // Create the course and enroll the professor in one transaction
        const course = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e0706aec._.js.map