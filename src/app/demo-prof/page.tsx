      ...
      <div className="bg-white w-full h-full rounded shadow-md flex flex-col p-10 overflow-hidden">
        ...
        <div className="flex-1 space-y-5 overflow-hidden">
          ...
          <div className="bg-stone-50 border border-stone-200 rounded-md p-4 font-mono text-sm leading-relaxed">
            ...
            <div className="pl-12"><span className="text-blue-600">if</span> arr[mid] == target: <span className="text-blue-600">return</span> mid</div>
            <div className="pl-12"><span className="text-blue-600">elif</span> arr[mid] &lt; target: low = mid + <span className="text-green-700">1</span></div>
            <div className="pl-12"><span className="text-blue-600">else</span>: high = mid - <span className="text-green-700">1</span></div>
...
function Scene_GoLive() {
  const courses = [
    ...
    { id: "3", name: "CSC236", full: "Introduction to the Theory of Computation", semester: "Winter 2026" },
  ];
    ...
    <div className="flex flex-col min-h-full bg-stone-50">
      ...
      <div className="flex-1 max-w-6xl mx-auto w-full px-8 py-10">
        <div className="mb-10 flex items-start justify-between">
          <div>
            <h2 className="text-4xl font-extrabold text-stone-900 tracking-tight mb-2">My Lectures</h2>
          ...
          {courses.map((course, i) => (
            <div
              ...
              className={`group relative overflow-hidden flex flex-col p-6 sm:p-8 rounded-md transition-all duration-300 bg-white border-2 min-h-[20rem] ${
                i === 0 ? "border-stone-200 shadow-md hover:border-stone-300" : "border-stone-100 hover:border-stone-200"
              }`}
            >
              ...
              <div className="flex flex-col gap-1 mt-auto">
                <h3 className="font-extrabold text-3xl tracking-tight text-stone-900">{course.name}</h3>
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div className="bg-white border-b border-stone-200 px-4 py-2 flex items-center gap-2 shrink-0 z-[100]">
        <span className="text-xs font-bold text-stone-400 uppercase tracking-wider mr-1">Prof Onboarding:</span>
        {([1, 2, 3] as Scene[]).map((s) => (
          <button
            key={s}
            onClick={() => setScene(s)}
            className={`px-3 py-1.5 rounded-md text-sm font-medium transition-colors whitespace-nowrap ${
              scene === s ? "bg-stone-900 text-white" : "bg-stone-100 text-stone-600 hover:bg-stone-200"
            }`}
          >
            {SCENE_LABELS[s]}
          </button>
